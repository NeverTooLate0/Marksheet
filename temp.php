...
<body>
    ...
    $course2_name = "INNOVATION MANGEMENT AND NEW PRODUCTD";
    $course3_name = "COMPUTIONAL THINKING";
    $course4_name = "INTRODUCTION TO COMMUICATION SKILLS";
    $course5_name = "Yoga";
    $course6_name = "Python";
    ...
    <form action="" method="post">
        ...
        <input type="text" id="ca_grade1" name="ca_grade1" required><br><br>
        ...
        <input type="text" id="ca_grade2" name="ca_grade2" required><br><br>
        
        <label for="term_end_grade2">Term End Grade:</label>
        <input type="text" id="term_end_grade2" name="term_end_grade2" required><br><br>

        <!-- Course 3 -->
        <p><strong>Course Name:</strong> <?php echo $course3_name; ?></p>
        <label for="ca_grade3">CA Grade:</label>
        <input type="text" id="ca_grade3" name="ca_grade3" required><br><br>
        
        <label for="term_end_grade3">Term End Grade:</label>
        <input type="text" id="term_end_grade3" name="term_end_grade3" required><br><br>


         <!-- Course 4 -->
         <p><strong>Course Name:</strong> <?php echo $course4_name; ?></p>
        <label for="ca_grade4">CA Grade:</label>
        <input type="text" id="ca_grade4" name="ca_grade4" required><br><br>
        ...
        <input type="text" id="ca_grade5" name="ca_grade5" required><br><br>
        ...
        <input type="text" id="ca_grade6" name="ca_grade6" required><br><br>
        
        <label for="term_end_grade6">Term End Grade:</label>
        <input type="text" id="term_end_grade6" name="term_end_grade6" required><br><br>
    ...
    ?>
    <table>
        <tr><th colspan="12" rowspan="" id="titl"> SYMBIOSIS INTERNATIONAL (DEEMED UNIVERSITY)
            (Established under section 3 of the UGC act 1956) Re-accredited by NAAC
            with ‘A++’ Grade Gram-Lavale, Tal- Mulshi, Dist-Pune Pin Code- 412115 Web
            Site : www.siu.edu.in, Email : coe@siu.edu.in</th></tr>
        
        <tr><th colspan="12"   id="title1">eGRADESHEET</th></tr>
        
        <tr><th colspan="12"> INSTITUTE :SYMBIOSIS INSTITUTE OF COMPUTER STUDIES AND RESEARCH, PUNE</th></tr>
       
        <tr><th colspan="12"> PROGRAMME :BACHELOR OF COMPUTER APPLICATIONS - HONOURS/ HONOURS </th></tr>
            
        <tr><th colspan="12">SEMESTER : I MONTH & YEAR OF EXAM: ODD 2024</th></tr>
        <tr><th colspan="12">SEAT NO. : 467506 PRN: 24030124031</th></tr>
        <tr><th colspan="12">NAME : Azzam ali mustafa mohammed </th></tr> 
